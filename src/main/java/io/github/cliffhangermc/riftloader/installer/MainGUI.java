package io.github.cliffhangermc.riftloader.installer;
...
public class MainGUI extends JFrame {
    ...
    public MainGUI() throws HeadlessException {
        ...
        loaderVersionPanel.add(new JLabel("Rift Loader version:"));
        JComboBox<String> loaderVersionCombo = new JComboBox<>();
        new Thread(() -> {
            // We use ghproxy here so that part of the users can use this without exceptions.
            String xml = readString("https://ghproxy.com/https://raw.githubusercontent.com/CliffhangerMC/mvn-repo/main/org/dimdev/RiftLoader/maven-metadata-local.xml");
        ...
        install.addActionListener(e -> {
            ...
            if (gameVersion == null || loaderVersion == null) {
                ...
                try {
                    ...
                    String name = String.format("Rift-%s-%s", gameVersion, loaderVersion);
                    ...
                    JOptionPane.showMessageDialog(null, "Rift has been successfully installed into your game directory.");
